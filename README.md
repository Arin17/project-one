...
- [User Experience (UX)](#user-experience--ux-) ##### EDIT AND ADD WIREFRAMES #####
...
## Wireframes
Wireframes for Dublin Minds were produced using [Balsamiq](https://balsamiq.com) desktop application.  Balsamiq offers frames suited to full width screens as well as portable mobile devices.

The final website designed for Dublin Minds, slightly varies from the wireframe design.  Wireframing was useful in sketching out the proposed design whilst brainstorming, to arrive at a visual cue of the design layout.  Based on the Skeleton phase of UX Design, the produced wireframe designed layout was used as a foundation for the developmental process of Dublin Minds website.  Below are images of the produced wireframes for desktop layout and mobile device layout.
...
## Design Choices
This section delves into choices made to provide an asthetically pleasing experience whilst journeying through Dublin Minds' website.

  * ### Typography
  The fonts selected are 'Ubuntu' for the headings and 'Nunito' for the body text. Each fall back to sans-serif.
    * 'Ubuntu' was chosen for the headings due to it's subtle boldness and to give the site visitor a bold but calming and welcoming feel.
    * 'Nunito' is used for the body text as it provides a nice calming and inviting feel whilst being clear and easy to read for all.

  * ### Colour Scheme
  The chosen colour scheme is based on the primary colour 'Blue'. The colour scheme applied globally to the website was derived from the colours in the hero image, which appears on the home page. The colour 'Blue' is naturally calmimg and goes well with the overall theme of the website, given that Dublin Minds promotes mindfulness and wellbeing as an experience it hopes it's users and site visitors will avail of.

  ![Colour Palette image](assets/readme-images/colour-palette.PNG)
...
## Existing Features  
  * ### Navigation Menu
    ...
    * Situated at the top of all the pages in the website, it is fully responsive and contains links to all the pages of the website.  It is designed to enable ease of navigation coupled with being placed in a convenient location.
...
[Back to top](<#contents>)
  ...
  * ### Home
    ...
    * The home page is the landing page for Dublin Minds website, it represents the reception area of a physical site where visitor's are received and hence have their first encounter with Dublin Minds.  With this in mind, the home page reflects on this, efforts have been made to provide a positive first encounter for the site visitor in an attempt to ensure there is calmness upon visitation which in effect provides the possibility of journeying through the whole website and also encourage a return visit.

    ![Home page image](assets/readme-images/home-pg.png)

[Back to top](<#contents>)

  * ### Techniques

    * The techniques page provides the site visitor with a couple of videos that can assists the user to practice mindfulness and wellbeing techniques on their own and at their leisure.  Upon rendering the webpage, the videos load muted and also the site visitor is provided with an option to play the video.
    ...
    * This section would be updated as and when new techniques are introduced to the field to reflect an ever growing development in the field.
    ...
    ![Techniques page image](assets/readme-images/gallery2.PNG)
...
[Back to top](<#contents>)
  ...
  * ### Bookings
    * This page provides the site visitor with a form for booking a session with Dublin Minds.

    ![Bookings page image](assets/readme-images/bookings-pg.PNG)
...
[Back to top](<#contents>)
  ...
  * ### Contact Us
    ...
    * There is a form that the user can choose to fill in. It has 4 input fields, name, email, address, and a textarea.  The submit button is used to send the details entered to Dublin Minds, this submit button also calls up the response page.

    ![Contact Us page image](assets/readme-images/contact-pg.PNG)
...
[Back to top](<#contents>)
  ...
  * ### Online Magazine
    * As an extra for the site visitor and to provide a lasting end of journey experience with the hope of a return visit, a convenient link is provided to access Dublin Minds publications.  The Online Magazine navigation menu item is simply a link that opens a magazine cover page in a new tab.

![Form confirmation image](assets/mags/cover-mag.PNG)
